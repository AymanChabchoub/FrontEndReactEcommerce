...
const stripePromise =loadStripe('pk_test_51QZzYRKNym3htWd4vFvXEYiCzCRm5hINiXInegF3NzHgeqrQNpWfBILCMgahLq93dCEbNjlJk7ZCuoKO7m4ORETo003UWPlLX3');
...
const Cart = () => {
    const {
      ...
      const handleSubmit = async (event) => {
        ...
        await axios
          .post("http://localhost:8000/api/payment/processpayment", {
