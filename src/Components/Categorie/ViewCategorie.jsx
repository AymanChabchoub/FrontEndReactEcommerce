...
const ViewCategorie = ({categories}) => {
    ...
    const columns = useMemo(
        ...
        >
        <img alt=""width={200} height={80} src={cell.getValue()} loading="lazy" style={{ borderRadius: '5%' }}/></Box>),
        },
        ...
        },
        {
            ...
            <Button onClick={() => {}} variant="contained" color="error" style={{ fontSize: '20px', padding: '12px 24px' }}>
